...
Stub specs for visual/UX ideas. Each file is a seed — flesh out into a full spec before implementing.

Format: problem → approach sketch → open questions → references. Keep stubs short; the point is to remember the idea, not design it prematurely.
...
- [headline-golden.md](headline-golden.md) — frozen-frame golden for the restacked headline; deferred until layout is locked
